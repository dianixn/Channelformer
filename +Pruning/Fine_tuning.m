...
SNR_range = 5:5:25;
Num_of_frame_each_SNR = 3000;
Channel_type = 'Propogation';

numEpochs = 10;
learnRate = 2e-3;
Dropperiod = [10, 30, 50, 70, 90];
Droprate = 0.5;
L2Regularization = 0.0000001;
Validation_frequency = 100;

File = 'parameters_frame_3_decode.mat';

Threshold_Encoder_Ratio = 0.1;
Threshold_Decoder_Ratio = 0.1;

[parameters, Commend] = Pruning.Hybrid_Pruning(File, Threshold_Encoder_Ratio, Threshold_Decoder_Ratio);
