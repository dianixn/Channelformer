...
%AveragePathGains = [0 -10 0 5.0 -7.0 -11.0 5.0 -1.5 -15.0 -1.0]; 

%PathDelays = [0 50 120 200 230 500 1600 2300 3200] * 1e-9; 
%AveragePathGains = [-1.0 -10.0 0 5.0 -7.0 -11.0 1.0 -15.0 -1.0]; 
